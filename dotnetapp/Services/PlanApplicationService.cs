...
namespace dotnetapp.Services
{
    public class PlanApplicationService : IPlanApplicationService
    {
        ...
        public PlanApplicationService(ApplicationDbContext context,IUserLogService userLogService)
        {
            _context = context;
        ...
        public async Task<bool> AddPlanApplication(PlanApplication planApplication)
        {
            ...
            await _userLogService.LogActionAsync(planApplication.UserId,"Applied for a savings plan");
        ...
        public async Task<bool> UpdatePlanApplication(int planApplicationId, PlanApplication planApplication)
        {
            ...
            //Save to database
            await _context.SaveChangesAsync();
            await _userLogService.LogActionAsync(planApplication.UserId,"Updated the details of savings plan application");
            return true;
        }
        ...
        public async Task<bool> DeletePlanApplication(int planApplicationId)
        {
            ...
            await _context.SaveChangesAsync();
            await _userLogService.LogActionAsync(planApplication.UserId,"Deleted the application for a savings plan");
            return true;
        }
    }
}